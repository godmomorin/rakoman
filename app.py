...
TEMPLATES = {'404.html': '{% extends "base.html" %}\n'
 ...
 'index.html': '{% extends "base.html" %}\n'
               ...
               '    </div>\n'
               '    <div class="body">\n'
               '      {% if p.genre %}<a class="genre-badge" style="background:{{ GENRE_COLOR.get(p.genre,\'#7a7484\') }};display:block;text-align:center;border-radius:12px;padding:3px '
               '8px;margin-bottom:4px;font-size:.82rem"\n'
               ...
               '      <div class="meta user-link" data-user="{{ p.username }}" title="{{ p.username }}のプロフィールを見る" style="cursor:pointer">\n'
