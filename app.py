...
TEMPLATES = {'404.html': '{% extends "base.html" %}\n'
 ...
 'base.html': '<!DOCTYPE html>\n'
              ...
              '.card{background:#fff;border:2.5px solid var(--ink);border-radius:var(--radius);overflow:hidden;box-shadow:var(--shadow);cursor:pointer;transition:transform .12s}\n'
              '.card:hover{transform:translateY(-3px) rotate(-.4deg)}\n'
              '\n'
              '\n'
              '.card .body{padding:8px 12px 10px;display:flex;flex-direction:column;gap:3px}\n'
              ...
              '\n'
              '.thumb{aspect-ratio:16/10;width:100%;overflow:hidden;display:flex;align-items:center;justify-content:center;font-size:2.2rem;border-bottom:2.5px solid var(--ink);position:relative}\n'
 ...
 'index.html': '{% extends "base.html" %}\n'
               ...
               '}};border:2px solid var(--ink);text-decoration:none">{{ p.genre }}</a>\n'
               '      {% endif %}\n'
